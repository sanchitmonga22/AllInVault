...
This script transcribes previously downloaded podcast episodes using Deepgram API
and stores the transcripts in the specified directory.
"""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=120,
        help="Minimum duration in seconds to consider an episode for transcription (default: 120s)"
    )
